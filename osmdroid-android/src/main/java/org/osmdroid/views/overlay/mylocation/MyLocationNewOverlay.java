...
public class MyLocationNewOverlay extends Overlay implements IMyLocationConsumer,
    ...
    public MyLocationNewOverlay(MapView mapView) {
        this(new GpsMyLocationProvider(mapView.getContext()), mapView, null);
    }

    public MyLocationNewOverlay(IMyLocationProvider myLocationProvider, MapView mapView, OnLocationChangedListener onLocationChangedListener) {
        super();
        mScale = mapView.getContext().getResources().getDisplayMetrics().density;
        myLocationProvider.setOnLocationChangedListener(onLocationChangedListener);
    ...
    /**
     * A listener that listens for changes in position.
     * This is a good choice when you want to automatically move to the middle of the screen when you located .
     */
    public interface OnLocationChangedListener {
        /**
         * Called When the location is completed or the position is changed.
         *
         * @param location
         */
        ...
        /**
         * If you want to disable the listener, return false;Otherwise it returns true
         *
         * @return
         */
        boolean getEnable();
